...
Podemos representar essa lista com um número mais simples, que pode resumir ou representar aquela lista original. Para isso, utilizamos as **estimativas de localização**. As mais comuns são **média** e **mediana**.
...
A função **mean,** no R, recebe como parâmetro uma lista de itens e retorna a média dessa lista.
...
Um dos pioneiros na definição da área de análise exploratória de dados (em inglês Estatistical Data Analisys, ou EDA) foi Tukey (1997) [@tukey1977exploratory]. Tukey (1997) em seu artigo disse que era anteriormente mais focado em inferências a partir de exemplos particulares para a população. O foco dele e de outros estatísticos estavam em desenvolver novas técnicas para inferência. Porém, depois de reflexão, ele chega a conclusão de que o foco dele e de outros estatísticos seria melhor aplicado no desenvolvimento de técnicas para a análise dos dados anterior a esse processo inferência. Era nos procedimentos de estruturar os dados que na estava o verdadeiro desafio. Problemas, tais como, lidar com dados faltantes e com dados *outliers* traziam impactos negativos e novas técnicas nessa etapa precisavam ser criadas. Sua recomendação era uma mudança de paradigma e novos estudos. Sua visão é que isso iria trazer enorme avanços como um todo. O que de fato aconteceu.
